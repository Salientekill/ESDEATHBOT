...
const makeGroupsSocket = (config) => {
    ...
    return {
        ...
        groupCreate: async (subject, participants) => {
            var _a;
            const key = (0, Utils_1.generateMessageIDV2)((_a = sock.user) === null || _a === void 0 ? void 0 : _a.id);
            ...
            await groupQuery(jid, 'set', [
                {
                    tag: 'description',
                    attrs: {
                        ...(description ? { id: (0, Utils_1.generateMessageIDV2)((_b = sock === null || sock === void 0 ? void 0 : sock.user) === null || _b === void 0 ? void 0 : _b.id) } : { delete: 'true' }),
                        ...(prev ? { prev } : {})
                    },
                    content: description ? [
        ...
        groupAcceptInviteV4: ev.createBufferedFunction(async (key, inviteMessage) => {
            ...
            await upsertMessage({
                key: {
                    ...
                    id: (0, Utils_1.generateMessageIDV2)((_a = sock === null || sock === void 0 ? void 0 : sock.user) === null || _a === void 0 ? void 0 : _a.id),
                    fromMe: false,
